...
data class CutoutConfig(
    ...
    val compactMediaWidthDp: Float = 152f,   // Compact width for media playback
    val compactNotifWidthDp: Float = 176f,   // Compact width for notification preview (clears notification icons)
    val compactBatteryWidthDp: Float = 116f, // Compact width for battery HUD
    val compactTimerWidthDp: Float = 130f,   // Compact width for countdown timer
    val compactVolumeWidthDp: Float = 116f,  // Compact width for volume indicator
    val compactPillWidthDp: Float = 152f,    // Default compact width fallback
